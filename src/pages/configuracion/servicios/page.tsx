...
import WorkOrderServiceTypeForm from '../catalogos/components/WorkOrderServiceTypeForm'
import WorkOrderServiceTypeList from '../catalogos/components/WorkOrderServiceTypeList'
...
const ServiciosPage: React.FC = () => {
  ...
  const handleChangeState = (record: WorkOrderServiceType) => {
    modal.confirm({
      title: 'Confirmación',
      content: 'Seguro que desea cambiar el estado del servicio?',
      onOk: async () => {
        try {
          await updateRow({
